        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {industries.map((ind, i) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="relative z-10 w-12 h-12 rounded-xl bg-navy-900/5 border border-navy-900/10 flex items-center justify-center mb-5 group-hover:bg-white group-hover:border-energy/20 group-hover:shadow-[0_4px_16px_rgba(0,200,81,0.15)] transition-all duration-300">
